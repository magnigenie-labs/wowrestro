<?php
/**
 * WoWRestro Product End
 *
 * This template can be overridden by copying it to yourtheme/wowrestro/wowrestro-product-end.php.
 *
...
<div class="wwr-mobile-category-wrap dk-none">
	...
	<span class="wwr-mobile-menu-txt wwr-primary-color"><?php echo __( 'Menu','wowrestro' )?></span>
</div>